            ...
            promise.then(function(messages) {
                ...
                $(messages).each(function(i, value) {
                    ...
                    if (value.sender_id == 'staff_' + staff_id) {
                        clientUl.prepend('<li class="sent" id="' + value.id + '">' + not_seen_icon + '<img data-toggle="tooltip" data-container="body" data-placement="top" title="<?= _l('chat_sent_at') ?>' + value.time_sent_formatted + '" class="myProfilePic" src="' + own_image_url + '"/><p class="you" id="msg_' + value.id + '" data-toggle="tooltip" title="' + (!isViewed ? '<?= _l('chat_not_seen'); ?>' : '<?= _l('chat_msg_seen'); ?> ' + moment(value.viewed_at).format('h:mm:ss A, MMM YYYY')) + '">' + value.message + '</p>' + optionsMore + '</li>');
                    ...
                    .done(function(messages) {
                        ...
                        $(messages).each(function(i, value) {
                            ...
                            if (value.sender_id == 'staff_' + userSessionId) {
                                clientUl.prepend('<li class="sent" id="' + value.id + '"><img data-toggle="tooltip" data-container="body" data-placement="left" data-original-title="' + value.time_sent_formatted + '" class="myProfilePic" src="' + own_image_url + '"/><p class="you" id="msg_' + value.id + '">' + value.message + '</p>' + optionsMore + '</li>');
