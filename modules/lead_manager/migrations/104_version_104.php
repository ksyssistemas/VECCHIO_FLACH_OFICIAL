...
class Migration_Version_104 extends App_module_migration
{
    public function up()
    {
        ...
        if (!$template_exists_lead) {
            $CI->db->query("INSERT INTO `" . db_prefix() . "emailtemplates` (`type`, `slug`, `language`, `name`, `subject`, `message`, `fromname`, `fromemail`, `plaintext`, `active`, `order`) VALUES ('lead_manager', 'lead-manager-send-to-lead', 'english', 'Lead Manager (Sent Zoom Link)', 'Lead Manager Sent Zoom Link','" . $lead_template . "','', NULL, 0, 1, 0);");
        }
