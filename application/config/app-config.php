...
*
*/
define('APP_BASE_URL', 'https://vecchio.ksys.net.br/wb/');
...
*/
define('APP_ENC_KEY', '7e7cd01bf864943edb571c34c8985f64');

/**
 * Database Credentials
 * The hostname of your database server
 */
define('APP_DB_HOSTNAME', 'db01.ksys.net.br');
 ...
 */
define('APP_DB_PASSWORD', 'Ksys2021#');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'crm_wb');
