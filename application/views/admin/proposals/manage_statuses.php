            ...
            <div class="col-md-12">
                <div class="tw-mb-2 sm:tw-mb-4">
                    <a href="#" onclick="new_status(); return false;" class="btn btn-primary">
                        ...
                        <?php echo _l('proposals_new_status'); ?>
                    </a>
                </div>
                <div class="panel_s">
                    <div class="panel-body panel-table-full">
                        ...
                        <table class="table dt-table" data-order-col="1" data-order-type="asc">
                            <thead>
                                ...
                                <th><?php echo _l('proposals_status_table_name'); ?></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="text-muted">
                                            <?php echo _l('proposals_table_total', total_rows(db_prefix() . 'proposals', ['status' => $status['id']])); ?></span>
                                    </td>
                                    <td>
                                        ...
                                        <?php if ($status['id'] != 1) { //Se for status aceito nao pode editar?>
                                            ...
                                            <a href="<?php echo admin_url('proposals/delete_status/' . $status['id']); ?>"
                        ...
                        <?php } else { ?>
                        <p class="no-margin"><?php echo _l('proposals_statuses_not_found'); ?></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
...
<?php include_once(APPPATH . 'views/admin/proposals/status.php'); ?>
<?php init_tail(); ?>
</body>
