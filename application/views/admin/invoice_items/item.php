...
<?php if(get_option('integrado_logosystem')){ ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <span id="item_long_description"></span>
                        </div>
                        <div class="form-group">
                            <label class="control-label"> 
                                <?=_l('invoice_item_short_description')?>
                            </label>
                            <br>
                            <span id="item_short_description"></span>
                        </div>
                        <div class="form-group">
                            <label class="control-label"> 
                                <?=_l('invoice_item_shortened_description')?>
                            </label>
                            <br>
                            <span id="item_shortened_description"></span>
                        </div>
                        <div class="form-group">
                            <label class="control-label"> 
                                <?=_l('invoice_item_comments')?>
                            </label>
                            <br>
                            <span id="item_comments"></span>
                        </div>
                        <div class="clearfix mbot15"></div>
                        <div class="form-group">
                        <label class="control-label">
                            <?php echo _l('invoice_item_add_edit_rate_currency', $base_currency->name . ' <small>(' . _l('base_currency_string') . ')</small>'); ?></label>
                            <span id="item_rate"></span>
                        </div>
                        <div class="form-group">
                            <label class="control-label"> 
    ...
    $("body").on('show.bs.modal', '#sales_item_modal', function (event) {
        ...
        if (typeof (id) !== 'undefined') {
            ...
            requestGetJSON('invoice_items/get_item_by_id/' + id).done(function (response) {
                ...
                $('#item_description').html(response.description);
                $('#item_short_description').html(response.short_description);
                $('#item_shortened_description').html(response.shortened_description);
                $('#item_comments').html(response.comments);
                $('#item_long_description').html(response.long_description.replace(/(<|<)br\s*\/*(>|>)/g, " "));
                $('#item_rate').html(response.rate);
                $('#item_unit').html(response.unit);
                $('#item_color').html(response.cor_logosystem);
                $('#item_size').html(response.tamanho_logosystem);
                $('#item_qtd_estoque').html(response.qtd_estoque_logosystem);
